    ...
    <nav class="navbar navbar-light bg-danger ">
        ...
        <div class="right_content_db">
          <form action="{{url('/rider/logout')}}" method="post">
              ...
              <div class="btn-group col-12" role="group" aria-label="Basic example">
                <button type="button" class="btn btn-outline-danger active text01" onclick="location.href = '{{url('rider/delivery')}}'">รับออเดอร์<span class="badge rounded-pill bg-danger" >{{$level1}}</span></button>
              ...
              <div id="onTop" class="card">
                <h5 class="card-header bg-danger text-white">งานที่ 1 #85</h5>
                <div class="card-body">
                  <p class="card-text">ร้านแบมบูใหญ่</p>              
                  <p class="card-text">ร้านชิวเอ้าท์</p>
                  <p class="card-text">ร้านบ้านขนม</p>
                  <p class="card-text">สน.สุวินทวงศ์</p>
                  <a  id="onLeft" href="#" class="btn btn-danger">รับออเดอร์</a>
                </div>
              </div>
            </div>
        -->
        @foreach($data as $row)
          <div class="card a01">
            ...
            <a id="aap" href="{{url('rider/cornfirm_order',$row->Or_ID)}}" class="btn btn-success">รับออเดอร์</a>
            <br>
          </div>
        @endforeach
        {{-- <div class="card">
          ...
          <a  id="aap" href="#" class="btn btn-success">รับออเดอร์</a>
          <br>
        </div> --}}
      </div>
</body>
