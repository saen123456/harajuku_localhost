...
<body class="dashboard">
            ...
            <div class="sidenav-db">
                ...
                <div class="sidenav-2">
                    ...
                    <div class="sidebar">
                        ...
                        <a class="bt row active" href="{{ url('/manage_money02') }}">
                            <div class="col-9">รายการย้อนหลัง</div><div class="col-3 num">2</div>
                        </a>
                        <a class="bt row" href="{{ url('/manage_money03') }}">
    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                <div class="head-list"><a href="#" class="hamber"><img src="../assets/icon/hamberger.png"></a>รายการย้อนหลัง</div>
                <hr class="line_hr">
                <div class="search"><a href="#"><img src="../assets/icon/search.png">ค้นหา</a> <a href="#">รายการทั้งหมด</a><a href="#">รายการเงินเข้า</a><a href="#">รายการแจ้งถอน</a></div>
            </div>
            <div class="card-list">
                <!--loop 1 -->
