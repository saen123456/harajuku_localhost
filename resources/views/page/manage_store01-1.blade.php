    ...
    <script>
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            data: [{
                ...
                dataPoints: [
                    { x: new Date(2021, 05, 25), y: 40.3, label: "Q1-2015" },
                    { x: new Date(2021, 05, 27), y: 43.0, label: "Q2-2015" },
                    { x: new Date(2021, 05, 29), y: 47.0, label: "Q3-2015" },
                    { x: new Date(2021, 06, 1), y: 48.0, label: "Q4-2015" },
                    { x: new Date(2021, 06, 15), y: 49.5, label: "Q1-2016" },
                    { x: new Date(2021, 06, 27), y: 51.1, label: "Q2-2016" },
                    { x: new Date(2021, 07, 1), y: 55.4, label: "Q3-2016" },
                    { x: new Date(2021, 07, 7), y: 60.5, label: "Q4-2016" },
                    { x: new Date(2021, 07, 15), y: 78.3, label: "Q1-2017", indexLabel: "Highest", markerColor: "red" }
                ]
            }]
        });
        chart.render();
...
<body class="dashboard">
    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                <div class="head-list"><a href="#" class="hamber"><img src="../assets/icon/hamberger.png"></a>ภาพรวม(แบบ Graph)</div>
                <hr class="line_hr">
                <div class="search"><a href="#"><img src="../assets/icon/fillter.png">เพิ่มตัวกรอง</a> <a href="{{url('/manage_store01')}}"><img src="../assets/icon/graph.png">แบบ Table</a></div>
            </div>
            <div class="card-list">
                <!--loop 1 -->
