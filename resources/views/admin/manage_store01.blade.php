    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                ...
                <hr class="line_hr">
                <div class="search"><a href="#"><img src="{{asset('assets/icon/fillter.png')}}">เพิ่มตัวกรอง</a> <a href="{{url('manage_store01-1')}}'"><img src="{{asset('assets/icon/graph.png')}}">แบบ Grahp</a></div>
            </div>
            <table class="table">
                <thead>
                  <tr>
