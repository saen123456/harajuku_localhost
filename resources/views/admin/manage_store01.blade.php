...
<body class="dashboard">
    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                <div class="head-list"><a href="#" class="hamber"><img src="../assets/icon/hamberger.png"></a>ภาพรวม</div>
                <hr class="line_hr">
                <div class="search"><a href="#"><img src="../assets/icon/fillter.png">เพิ่มตัวกรอง</a> <a href="manage_store01-1.html"><img src="../assets/icon/graph.png">แบบ Grahp</a></div>
            </div>
            <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td></td>
                    <th scope="row">กำลังดำเนินการ</th>
                    <td>3</td>
                    <td>ออเดอร์</td>
                  </tr>
                  <tr>
