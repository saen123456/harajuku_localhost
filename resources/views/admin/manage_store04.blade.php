...
<body class="dashboard">
    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                <div class="head-list"><a href="#" class="hamber"><img src="{{asset('assets/icon/hamberger.png')}}"></a>คูปอง</div>
                <hr class="line_hr">
                ...
                <div class="order-hara row">
                    <div class="card mx-auto order col-md-12">
                        <div class="d-flex bd-highlight grey">
                            <div class="col"></div>
                            <div class="col">ชื่อหมวดหมู่</div>
                            <div class="col">รหัส/เงื่อนไข</div>
                            <div class="col">จำนวนสิทธิ์</div>
                            <div class="col">ระยะเวลา</div>
                            <div class="col">เปิดใช้งาน</div>
                            <div class="col"></div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="col">ตรุษจีน</div>
                                <div class="col">Code : Save5ofeb</div>
                                <div class="col">99(เหลือ 90)</div>
                                <div class="col">7 วัน(15/02/64 - 22/02/64)</div>
                                <div class="col"><input type="checkbox" class="form-check-input" id="dropdownCheck"></div>
