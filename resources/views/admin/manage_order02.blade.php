...
<body class="dashboard">
            ...
            <div class="sidenav-db">
                ...
                <div class="sidenav-2">
                    ...
                    <div class="sidebar">
                        ...
                        <a class="bt row active" href="{{ url('/manage_order02') }}">
    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                <div class="head-list"><a href="#" class="hamber"><img src="{{asset('assets/icon/hamberger.png')}}"></a>รายการที่ยอมรับ (กำลังปรุง)</div>
                <hr class="line_hr">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document"">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="cancel btn btn-success">ยืนยันการยกเลิก</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mx-auto order col-md-12">
                        <div class="d-flex bd-highlight grey">
                            ...
                            <div class="row more">
                                ...
                                <div class="col-2">
                                    <div class="see-ord"><a type="button" class="btn btn-success"  href="{{url('/manage_order02/update', $row->Or_ID)}}">ยืนยัน</a></div>
                                </div>
                            </div>
                    </div>
                </div>
