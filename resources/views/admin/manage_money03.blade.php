...
<body class="dashboard">
        ...
        <div class="db-take">
            <div class="sidenav-db">
                <div class="sidenav-1">
                    ...
                    <a href="{{ url('/manage_money01') }}"  class="active">
                        <svg 
                ...
                <!--End sidenav-1 -->
                <div class="sidenav-2">
                    <div><h2>จัดการเงิน</h2></div>
                    <div class="sidebar">
                        <a class="bt row" href="{{ url('/manage_money01') }}">
                            <div class="col-9">รายการทั้งหมด</div><div class="col-3 num">3</div>
                        </a>
                        <a class="bt row" href="{{ url('/manage_money02') }}">
                            <div class="col-9">รายการย้อนหลัง</div><div class="col-3 num">2</div>
                        </a>
                        <a class="bt row active" href="{{ url('/manage_money03') }}">
                            <div class="col-9">ตั้งค่าบัญชีรับเงิน</div><div class="col-3 num">2</div>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                <div class="head-list"><a href="#" class="hamber"><img src="../assets/icon/hamberger.png"></a>ตั้งค่าบัญชีรับเงิน</div>
                <hr class="line_hr">
                <div class="search"><a href="#" data-toggle="modal" data-target="#mymodal" >เพิ่มบัญชี</a></div>
            </div>
            <div class="card-list">
                <div class="container">
                    <!--Modal popup-->
                                ...
                                <div class="modal-body">
                                    <form action="/action_page.php">
                                        <select name="cars" id="cars" >
                                            <option value="volvo">ธนาคารกสิกรไทย</option>
                                            <option value="saab">ธนาคารกรุงไทย</option>
                                                <option value="opel">ธนาคารไทยพาณิชย์</option>
                                            <option value="audi">ธนาคารออมสิน</option>
                                        </select>
                                    </form>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="cancel btn btn-success">เพิ่มบัญชี</button>
                                </div>
                            </div>
                        </>
                    </div>
