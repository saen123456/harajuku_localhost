    ...
    <div class="header_bottom sticky-header">
        <div class="container-fluid">
            <div class="row">
                ...
                <a href="index"><img src="/img/logo-take.png" width="50" height="15" alt="" data-retina="true" class="hidden-xs"></a>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="promotion_food">โปรโมชั่นอาหาร</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="promotion_food">โปรโมชันอาหาร</a></li>
                                    <li><a href="promotion_item">โปรโมชันของใช้</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="regis_vendor">สมัครเปิดร้านอาหาร</a></li>
                                    <li><a href="register_index_rider">สมัครไรเดอร์</a></li>
                    ...
                    <div class="row align-items-center" id="vendor_icon">
                        ...
                        <span class="categories_menu_toggle">
                            <ul>
                                ...
                                <li><a href="login">Login vendor</a></li>
                                ...
                                <li class="hidden"><a href="shop">New Sofas</a></li>
                                <li class="hidden"><a href="shop">Sleight Sofas</a></li>
                            </ul>
                        </span>
                        <ul>
