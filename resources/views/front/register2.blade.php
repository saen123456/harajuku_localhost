                ...
                <div class="account_form register">
                    ...
                    <form action="#">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <label for="">ที่อยู่1<span style="color: red;">*</span></label>
                            </div>
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="exampleInputAmount" placeholder="ที่อยู่1">
                                    </div>
                                </div>
                            </div>
                            <br>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <label for="">ประเทศ<span style="color: red;">*</span></label>
                            </div>
                            <div class="col-lg-8">
                                <div class="form-group">
