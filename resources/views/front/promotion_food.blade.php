...
<body>
    ...
    <div class="slider_area owl-carousel hidden-xs" style="margin-top: -10px;">
        <div class="single_slider single_slider3 d-flex align-items-center ">
    ...
    <div class="slider_area owl-carousel hidden-lg mt-lg-6" >
        <div class="single_slider single_slider3 d-flex align-items-center">
            <div class="container">
                <div class="row">
    ...
    <!-- ร้านอาหารแนะนำ -->
    <div class="container mt-30 hidden-xs">
    ...
    <div class="container mt-lg-3 mt-xs-3">
        <div class="row">
            <div class="col-lg-7 col-xs-12">
                <section class="slider_section mb-xs-5">
    ...
    <!-- สินค้าขายดี -->
    <div class="container mt-lg-5 mt-xs-2">
        <div class="section_title">
            <h2>โปรโมชั่น</h2>
        </div>
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                ...
                <div class="row shop_wrapper mt-lg-3">
