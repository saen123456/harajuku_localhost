...
<body>
    ...
    <div class="banner_fullwidth fullwidth2" style="background-image: url(img-take/สยามเนริ.png); height: 500px;">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <div class="shop_area shop_fullwidth mt-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-xs-12 topp2">
                    ...
                    <div class="shop_toolbar_wrapper" style="border:none;margin:0 0 0px">
                        ...
                        <div class=" niceselect_option">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active show" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">ทั้งหมด</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-2" aria-selected="false">งานแสดง</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">คอนเสริต</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-4-tab" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-4" aria-selected="false">กิจกรรม</a>
                                </li>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade active show" id="pills-1" role="tabpanel" aria-labelledby="pills-1-tab">
                                ...
                                <div id="listmunu" style="list-style: none;">
                                    <!-- <div class="row shop_wrapper"> -->
                                        <div class="col-lg-3 col-sm-4 col-xs-6 colvocher topp2">
                                            <figure>
                                                <a href=""><img src="img-take/vor_1.jpg" style="    width: 100%;
    height: 400px;
    object-fit: cover;" alt="">
                                                <br>
                                                    <h4>คุณพระช่วยสำแดงสด</h4>
                                                </a>
                                            </figure>
                                            <h5>21 พ.ย. 2563 - 22 พ.ย. 2563</h5>
                                                <div class="box_buycon">ซื้อบัตร</div>
                                        </div>
                                       
                                        <div class="col-lg-3 col-sm-4 col-xs-6 colvocher topp">
                                            <figure>
                                                <a href=""><img src="img-take/vor_2.jpg" style="    width: 100%;
    height: 400px;
    object-fit: cover;" alt="">
                                                <br>
                                                    <h4>คุณพระช่วยสำแดงสด</h4>
                                        ...
                                        <div class="col-lg-3 col-sm-4 col-xs-6 colvocher topp">
                                            <figure>
                                                <a href=""><img src="img-take/vor_3.jpg" style="    width: 100%;
    height: 400px;
    object-fit: cover;" alt="">
                                                <br>
                                                    <h4>คุณพระช่วยสำแดงสด</h4>
                                        ...
                                        <div class="col-lg-3 col-sm-4 col-xs-6 colvocher topp">
                                            <figure>
                                                <a href=""><img src="img-take/vor_4.jpg" style="    width: 100%;
    height: 400px;
    object-fit: cover;" alt="">
                                                <br>
                                                    <h4>คุณพระช่วยสำแดงสด</h4>
