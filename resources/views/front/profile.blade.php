                    ...
                    <div class="tab-content">
                                        ...
                                        <div class="tr_table" style="border: none;">
                                            <div class="table_tracking">
                                                <div class="row track_head">
                                                    <div class="col-lg-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-3 col-xs-3 track_date">
                                                            <h5>Date purchased</h5>Dec 1, 2017
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-xs-3 track_botton"><button data-toggle="modal" data-target="#modal_box6" type="summit">Manage Order</button></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row track_bottom">
                                                    <div class="col-lg-12 col-xs-12">
                                                        <div class="col-lg-3 col-xs-6 tracking_thumb"><a href="#"><img src="http://www.msr.co.th/wp-content/uploads/2019/08/P_28-%E0%B8%81%E0%B9%8B%E0%B8%A7%E0%B8%A2%E0%B9%80%E0%B8%95%E0%B8%B5%E0%B9%8B%E0%B8%A2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B8%95%E0%B8%A3%E0%B8%9E%E0%B8%B4%E0%B9%80%E0%B8%A8%E0%B8%A9-1024x1024.jpg" alt="" width="130"></a>
                                                        </div>
                                                        <div class="col-lg-5 col-xs-6 tracking_name">
                                                            <a href="">หอยทอด</a>
                                                            <br>
                                                            <h5><a href="">Maesriruen</a></h5>
                                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="Shipping" role="tabpanel">
                                        <div class="tr_table" style="border: none;">
                                            <div class="table_tracking">
                                                ...
                                                <div class="row track_bottom">
                                                    <div class="col-lg-12 col-xs-12">
                                                        <div class="col-lg-3 col-xs-6 tracking_thumb"><a href="#"><img src="https://assets.adidas.com/images/w_385,h_385,f_auto,q_auto:sensitive,fl_lossy/dbf421a63979498aa5c4a34e00f9edb5_9366/%E0%B8%A3%E0%B8%AD%E0%B8%87%E0%B9%80%E0%B8%97%E0%B9%89%E0%B8%B2-stan-smith.jpg" alt="" width="130"></a>
                                                        </div>
                                                        <div class="col-lg-5 col-xs-6 tracking_name">
                                                            <a href="">รองเท้า STAN SMITH</a>
                                                            <br>
                        ...
                        <div class="tab-pane fade" id="reviews" role="tabpanel">
                            ...
                            <div class="product_tracking_inner">
                                <div class="product_tracking_button">
                                    <ul class="nav" role="tablist">
                                        <li>
                                            <a class="active" data-toggle="tab" href="#Delivery2" role="tab" aria-controls="Delivery" aria-selected="false">Delivery</a>
                                        </li>

                                        <li>
                                            <a class="" data-toggle="tab" href="#Shipping2" role="tab" aria-controls="Shipping" aria-selected="false">Shipping</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="tab-pane fade" id="credit" role="tabpanel">
                            ...
                            <div class="product_d_inner">
                                <div class="box_style_2 info" style="line-height:24px; margin-bottom:140px; ">
                               ...
                               <h4>ขาด</h4> -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <button onclick="show1();" style="background-color: #1ab60d; width: 70%;" class="btn">เติมpoint</button>

                                            </div>
                                            <div class="col-lg-6">
                                                <button onclick="show2();" class="btn" style="width: 70%;  margin-left: -30px;   background-color: #b7b7b7;">ชำระเงินทันที</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <div id="money1" class="table_point">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="tkpoint1"><a onclick="show2();">50 (+10 PTS)</a> </td>
                                                        <td class="tkpoint"> <button onclick="show2();" class="button_wallet_money">THB 50</button></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tkpoint"> <i class="fas fa-coins" style="color:#FFD700;"></i></td>
                                                        <td class="tkpoint1"><a onclick="show2();">50100 (+20 PTS)</a></td>
                                                        <td class="tkpoint"> <button onclick="show2();" class="button_wallet_money">THB 100 </button></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tkpoint"><i class="fas fa-coins" style="color:#FFD700;"></i></td>
                                                        <td class="tkpoint1"><a onclick="show2();">501000 (+100 PTS)</a></td>
                                                        <td class="tkpoint"> <button onclick="show2();" class="button_wallet_money">THB 1000</button></td>
                                                        ...
                                                        <table class=" ">
                                                            <tr>
                                                                ...
                                                                <td class="tkpoint1"> <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <img class="pull-left" width="30" style="height: 30px;" src="assets/img/icon/visa.png" alt="">
                                                                            <img class="pull-left" width="30" style="height: 30px;" src="assets/img/icon/mastercard.png" alt="">
                                                    ...
                                                    <div class="cart_page">
                                                        <table class="">
                                                            <tr>
                                                                ...
                                                                <td class="tkpoint1"> <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                ...
                                                                <!-- <img class=" pull-right" width="150" src="assets/img/icon/papyel.png" alt=""> -->
                                                                            <img src="img-take/ibang_1.PNG" alt="" style="height: 25px;">
                                                                            <img src="img-take/ibang_2.PNG" alt="" style="height: 25px;">
                                                                            <img src="img-take/ibang_3.PNG" alt="" style="height: 25px;">
                                                                        </div>
                                                                    </button></td>
                                                            </tr>
                                                                    ...
                                                                    <div class="">
                                                                        <div>
                                                                            <div class="bank_choice">
                                                                                ...
                                                                                <label for="payment">ธนาคารกรุงไทย</label>
                                                                                <span for="payment">เลขบัญชี 444-444-4444</span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="">
                                                                        <div>
                                                                            <div class="bank_choice">
                                                                                ...
                                                                                <label for="payment">ธนาคารกสิกรไทย</label>
                                                                                <span for="payment">เลขบัญชี 444-444-4444</span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="">
                                                                        <div>
                                                                            <div class="bank_choice">
                                                                                ...
                                                                                <label for="payment">ธนาคารกรุงเทพ</label>
                                                                                <span for="payment">เลขบัญชี 444-444-4444</span>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="cart_page">
                                                        <table class="">
                                                            <tr>
                                                                ...
                                                                <td class="tkpoint1"> <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseTwo">
                                                                        ...
                                                                        <div class="col-lg-2 pull-left">
                                                                            <!-- <img class="pull-right" width="150" src="assets/img/icon/papyel.png" alt=""> -->
                                                                            <img src="assets/img/icon/paypal.png" alt="" style="height: 25px;">
                                                                        </div>
                                                                    </button></td>
                                                            </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal_body">
                        <div class="container">
                            ...
                            <a class="btn_full" href="c{{url('/checkout_3')}}">Confirm</a>
                        </div>
                    </div>
                </div>
            </div>
