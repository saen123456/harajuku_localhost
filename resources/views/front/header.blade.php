            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-2 col-xs-2">
                    ...
                    <div class="main-menu main-menu ml-lg-5 pull-left">
                        <div id="header_menu">
                            <a href="{{url('index')}}"><img src="img-take/Logo-Harajuku.png" width="50" height="23" alt="" data-retina="true"></a>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{url('promotion_food')}}">โปรโมชั่น</a></li>
                ...
                <nav class="col-lg-6 col-md-4 col-sm-7 col-xs-5">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <a href="{{url('index')}}"><img src="img/logo-take.png" width="45" height="23" alt="" data-retina="true" class="hidden-lg hidden-md" style="float:right;"></a>
                    ...
                    <div class="row align-items-center pull-right">
                        ...
                        <span class="categories_menu_toggle">
                            <ul>
                                ...
                                <li><a href="{{url('login')}}"> ล็อกอิน/ลงทะเบียน</a></li>
                                <li><a href="#">จัดการร้านอาหาร</a></li>
                                <li><a href="{{url('login')}}">ล็อกอินร้านค้า</a></li>
...
<div class="cartdown hidden-lg hidden-md">
    <div class="row">
        <div class="col-xs-4">
            <a href="{{url('cart')}}"> <span class="lnr lnr-cart"></span><span class="item_count">2</span></a>

        </div>
        <div class="col-xs-4">
            <a href="{{url('cart')}}">ดูรถเข็น</a>

        </div>
        <div class="col-xs-4">
            <a href="{{url('cart')}}">฿100.00</a>
