            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="product-details-tab">
                        <img src="img-take/ss2-ผัดไท-ไซส์-600.jpg" data-zoom-image="assets/img/product/productbig4.jpg" alt="big-1">
                    ...
                    <div class="product_d_right">
                        <form action="#">
                            ...
                            <div class="product_desc">
                                <p>
                                    ผัดไทยเส้นจันท์ หนึบ ๆ นุ่ม ๆ ผัดเข้ากับซอสสูตรพิเศษของทางร้าน
                                    บวกกับไข่ไก่คุณภาพเกรดพรีเมียม คัดสรจากฟาร์มไก่พันธุ์ดี
                                    นอกจากนี้ ทางร้านยังได้ไปคัดสรรอาหารทะเลเองกับมือ
                                    ตัวใหญ่ ๆ ตัวโต ๆ กัดเต็มปากเต็มคำ ถ้าพร้อมทานเเล้ว กดสั่งเลย !!
                                </p>
                            </div>
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    ...
                                    <a class="secondary_img" href="{{url('/product-details')}}l"><img src="assets/img/product/product14.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                                    <div class="action_links">
