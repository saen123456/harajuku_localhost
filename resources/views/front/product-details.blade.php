            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="product-details-tab">
                        <img src="assets/img/product/productbig4.jpg" data-zoom-image="assets/img/product/productbig4.jpg" alt="big-1">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                        <form action="#">
                            ...
                            <h1><a href="#">ก๋วยเตี๋ยวไก่ต้นตำรับ (น้ำ/แห้ง/ต้มยำ)</a></h1>
