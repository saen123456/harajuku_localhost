...
<body class="dashboard">
        ...
        <div class="db-take">
            <div class="sidenav-db">
                <div class="sidenav-1">
                    ...
                    <a href="{{url('/manage_event')}}" class="active">
                        <svg 
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <!--End sidenav-1 -->
                <div class="sidenav-2">
                    <div><h2>จัดการกิจกรรม</h2></div>
                    <div class="sidebar">
                        <a class="bt row" href="{{url('/manage_event')}}">
                            <div class="col-9">จัดการกิจกรรม</div>
                        </a>
                        <a class="bt row active" href="{{url('/add_event')}}">
                            <div class="col-9">เพิ่มกิจกรรม</div>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="row content-db">
        ...
        <div class="content2 col-10">
            ...
            <div class="list">
                <div class="head-list"><a href="#" class="hamber"><img src="../assets/icon/hamberger.png"></a>เพิ่มกิจกรรม</div>
                <hr class="line_hr">
                <div class="row">
            ...
            <div class="card-list">
                    ...
                    <div class="card mx-auto order col-md-12">
                        <form action="#">
                            ...
                            <p>
                                ...
                                <input type="datetime-local" class="form-control" style="width: 800px">
                            </p>
                            <p>
                        ...
                        <br><br>
                        <label>เลือกไฟล์ที่จะอัปโหลด</label>
                ...
                <br><br><button type="button" class="btn btn-success" style="float: right; width:130px">สร้าง</button>
                <br><br><br><br>
            </div>
        </div>
