(function ($) {
    ...
    var $porductColumn8 =  $('.product_column8');
    if($porductColumn8.length > 0){
        $porductColumn8.on('changed.owl.carousel initialized.owl.carousel', function (event) {
    ...
    $(".categories_title2").on("click", function() {
        $(this).toggleClass('active');
        $('.categories_menu_toggle2').slideToggle('medium');
    }); 
    ...
    $(".categories_menu_toggle2 li.hidden").hide();
    $("#more-btn").on('click', function (e) {

     e.preventDefault();
     $(".categories_menu_toggle2 li.hidden").toggle(500);
     var htmlAfter = '<i class="fa fa-minus" aria-hidden="true"></i> Less Categories';
     var htmlBefore = '<i class="fa fa-plus" aria-hidden="true"></i> More Categories';
    ...
    /*---Category menu---*/
    function categorySubMenuToggle(){
        $('.categories_menu_toggle2 li.menu_item_children > a').on('click', function(){
        if($(window).width() < 991){
            $(this).removeAttr('href');
            var element = $(this).parent('li');
            if (element.hasClass('open')) {
        ...
        $('.categories_menu_toggle2 li.menu_item_children > a').append('<span class="expand"></span>');
    }
    categorySubMenuToggle();
    ...
    $('.shop_toolbar_btn > button').on('click', function (e) {
        ...
        if(viewMode == 'grid_5'){
			parentsDiv.children().addClass('col-lg-4 col-md-4 col-sm-6').removeClass('col-lg-4 col-cust-5 col-12');
		}
