            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-2 col-xs-2">
                    <a href="index.php" id="logo">
                        <img  src="img-take/Logo-Harajuku.png" width="100" alt="" data-retina="true" class="hidden-sm hidden-xs" style="float:left;">
                    ...
                    <div class="main-menu main-menu ml-lg-5 pull-left">
                        <div id="header_menu">
                            <a href="index.php"><img src="img-take/Logo-Harajuku.png" width="50" height="23" alt="" data-retina="true"></a>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="delivery.php">รวมร้านอาหารทั้งหมด</a></li>
                                    <li><a href="allfoods.php">รวมอาหารทั้งหมด</a></li>
                                    <li><a href="promotion_food.php">โปรโมชั่น</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="menu-list2.php">รวมสินค้าทั้งหมด</a></li>
                                    <li><a href="promotion_item.php">โปรโมชั่น</a></li>
                ...
                <nav class="col-lg-6 col-md-4 col-sm-7 col-xs-5">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <a href="index.php"><img src="img/logo-take.png" width="45" height="23" alt="" data-retina="true" class="hidden-lg hidden-md" style="float:right;"></a>
                    ...
                    <div class="row align-items-center pull-right">
                        ...
                        <span class="categories_menu_toggle">
                            <ul>
                                ...
                                <li><a href="login.php"> ล็อกอิน/ลงทะเบียน</a></li>
                                <li><a href="#">จัดการร้านอาหาร</a></li>
                                <li><a href="login.php">ล็อกอินร้านค้า</a></li>
...
<div class="mini_cart">
      ...
      <div class="mini_cart_footer">
          <div class="cart_button">
              <a href="cart.php"><i class="fa fa-shopping-cart"></i> ดูตะกร้าสินค้า</a>
          </div>
          <div class="cart_button">
              <a href="checkout_1.php"><i class="fa fa-sign-in"></i> ชำระเงิน</a>
          </div>
...
<div class="cartdown hidden-lg hidden-md">
    <div class="row">
        <div class="col-xs-4">
            <a href="cart.php"> <span class="lnr lnr-cart"></span><span class="item_count">2</span></a>

        </div>
        <div class="col-xs-4">
            <a href="cart.php">ดูรถเข็น</a>

        </div>
        <div class="col-xs-4">
            <a href="cart.php">฿100.00</a>
